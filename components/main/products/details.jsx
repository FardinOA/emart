        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 base-container ">
          <div className="lg:col-span-4">
            <div className="rounded-xl lg:p-6 lg:border space-y-8 relative ">
              <Carousel>
                <CarouselContent>
                  {[data?.image].map((ele, ind) => (
                    <CarouselItem key={`details-carousel-${ind}`}>
                      <CustomImage src={ele} className={`    `} />
                    </CarouselItem>
                  ))}
                </CarouselContent>
          ...
          <div className="lg:col-span-4">
            <div className=" py-2 space-y-8 ">
              <div className="space-y-2">
                ...
                <p className=" text-sm    ">
                  <span className="font-semibold">SKU</span> : MOX200608
                </p>
                <p className=" text-sm    ">
              ...
              <div className="py-6 border-t-[1px] space-y-4">
                <div className="flex items-center gap-4">
                  {/* <p className="text-lg lg:text-2xl line-through t">$8900.00</p> */}
      ...
      <div className="container">
        ...
        >
          <CarouselContent className={"py-2 px-2"}>
            {relatedProduct?.map((ele, ind) => (
              <CarouselItem
                className={
                  "basis-[70%] md:basis-[40%] lg:basis-[25%] 2xl:basis-[20%] "
                }
                key={`related-product-${ele?.id}`}
              >
                <Card ele={ele} />
              </CarouselItem>
            ))}
